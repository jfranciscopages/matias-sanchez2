...
const Calendly = () => {
  return (
    <section className="w-11/12 sm:w-11/12  md:w-7/12 flex flex-col items-center justify-center gap-5 md:gap-0 md:justify-between max-w-[1350px] mx-auto bg-gradient-to-b from-black to-gray-800">
      <div className=" p-6 w-full bg-white rounded-2xl flex flex-col items-center justify-center h-[1350px]">
        <div className="flex flex-col justify-center items-center ">
          ...
          <br />
          <h2 className="text-black font-bold text-l text-center">
